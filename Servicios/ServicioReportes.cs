...
namespace ManejoPresupuestos.Servicios
{
    ...
    public class ServicioReportes: IServicioReportes
    {
            ...
            ObtenerReporteTransaccionesDetalladas(int usuarioId, int mes, int año, dynamic ViewBag)
        {
            ...
            var modelo = GeneraReportesTransaccionesDetalladas(fechaInicio, fechaFin, transacciones);
        ...
        private static ReporteTransaccionesDetalladas GeneraReportesTransaccionesDetalladas(DateTime fechaInicio, DateTime fechaFin, IEnumerable<Transaccion> transacciones)
        {
